  ...
  return (
    <header className="bg-black text-white px-6 py-4 flex items-center justify-between shadow-lg">
      <div className="flex items-center gap-3">
        ...
        <span className="text-xl font-bold tracking-tight">Playlist Builder</span>
      </div>
      ...
      {session ? (
        ...
        <button
          ...
          className="bg-[#1DB954] hover:bg-[#1ed760] text-black font-semibold px-5 py-2 rounded-full transition-colors text-sm"
        >
          Login with Spotify
        </button>
      )}
